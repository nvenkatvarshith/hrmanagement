                ...
                <div className="user-register mt-4 w-3xl">
                    <form>
                        ...
                        <div className="mt-5 text-gray-500">
                            <input type="checkbox" name="newsletter" id="newsletter" /> Yes, I want to receive KRIS newsletters
                            <div className="mt-2"><input type="checkbox" name="policies" id="policies" /> I agree to all the Terms, Privacy Policy</div>
                        </div>
                        <button className="border rounded-md bg-navyblue text-white py-3 px-9 mt-5">Create Account</button>
